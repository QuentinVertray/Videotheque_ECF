...
})({"jaAKs":[function(require,module,exports) {
...
var typed = new (0, _typedJsDefault.default)("#element", {
    strings: [
        "Here you can add every movie you want...",
        "or not...."
    ],
    typeSpeed: 30
});
...
window.onload = function() {
    ...
    form.onsubmit = function(event) {
        ...
        var errors = [];
        if (title.length < 2) errors.push("Le titre doit contenir au moins 2 caract\xe8res");
        if (year < 1900 || year > new Date().getFullYear()) errors.push("L'ann\xe9e doit \xeatre comprise entre 1900 et l'ann\xe9e en cours");
        if (author.length < 5) errors.push("Le r\xe9alisateur doit contenir au moins 5 caract\xe8res");
        ...
        if (errors.length === 0) {
            ...
            modal1.style.display = "none";
            afficherFilms(films);
        } else alert("Erreur dans le formulaire : " + errors.join(", "));
    };
};
...
document.getElementById("filter").addEventListener("change", function() {
    var sortedFilms;
    if (this.value === "decroissant") sortedFilms = sortByYearDescending(films);
    else if (this.value === "alphab\xe9tique") sortedFilms = sortByTitleAlphabetical(films);
    else sortedFilms = films; // Pas de tri, juste réinitialiser l'ordre des films au cas où un tri précédent a été appliqué
    afficherFilms(sortedFilms); // Utilisez la fonction d'affichage existante pour mettre à jour l'affichage
});

},{"typed.js":"6M0L2","@parcel/transformer-js/src/esmodule-helpers.js":"6W6ZT"}],"6M0L2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"6W6ZT"}],"6W6ZT":[function(require,module,exports) {
...
},{}]},["jaAKs","6Bv9J"], "6Bv9J", "parcelRequire94c2")
